...
import Hexzy.modules.sql.welcome_sql as sql
from Hexzy import (
    DEMONS,
    DEV_USERS,
    DRAGONS,
...
from Hexzy.modules.helper_funcs.chat_status import is_user_ban_protected, user_admin
from Hexzy.modules.helper_funcs.misc import build_keyboard, revert_buttons
from Hexzy.modules.helper_funcs.msg_types import get_welcome_type
from Hexzy.modules.helper_funcs.string_handling import (
    escape_invalid_curly_brackets,
    markdown_parser,
)
from Hexzy.modules.log_channel import loggable
from Hexzy.modules.sql.global_bans_sql import is_user_gbanned
    ...
    for new_mem in new_members:
        ...
        if should_welc:
            ...
            # Welcome Devs
                ...
                update.effective_message.reply_text(
                    "Whoa! A member of the Team RSR just joined!◉‿◉",
                    reply_to_message_id=reply,
                )
                continue
